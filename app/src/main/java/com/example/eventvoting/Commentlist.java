...
public class Commentlist extends AsyncTask<String,Integer,String> {
    ...
    public Commentlist(Context c, String address, ListView lv) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
       ...
       // pd.dismiss();
        ...
        if(s != null)
        {
            Commentdata p=new Commentdata(c,s,lv);
