...
public class Takevotepartidata extends AsyncTask<Void,Integer,Integer> {
    ...
    public Takevotepartidata(Context c, String data, Button txt1, Button txt2, Button txt3, Button txt4, Button txt5, Button txt6, Button txt7, Button txt8, Button txt9, Button txt10) {
        this.c = c;
        this.data = data;
        this.txt1=txt1;
        this.txt2=txt2;
